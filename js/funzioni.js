/*
	Function that select the payment method of reserve.html page
*/
...
/*	
	...
	the change of X and Y filters of overview.html page
*/
...
/*
	...
	that are default set on the overview.html page  
	
	NEW FEATURE: Function responsible of the redirecting on overview.html page for the loading
...
function checkInputValues() {
	...
	if (error == true) {
		...
		document.getElementById("inviaDati").action = "inviaDatiCompany.html";
